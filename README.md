...
- [三、硬件连接步骤](#三硬件连接步骤)
- [四、软件环境安装](#四软件环境安装)
- [五、创建PlatformIO项目](#五创建platformio项目)
- [六、编写程序代码](#六编写程序代码)
- [七、编译和烧录程序](#七编译和烧录程序)
- [八、测试和验证](#八测试和验证)
- [九、无人值守设置](#九无人值守设置)
...
### 2. 设备引脚说明：
#### [ESP32 C3 SuperMini](./images/ESP32C3.png)引脚：
- 5V：5V电源输入
- GND：接地
- GPIO4：SWDIO接口
- GPIO5：SWCLK接口
...
#### [ML307A-GSLN核心板](./images/ML307R.png)引脚：
- VIN：电源输入（5V-16V）
- GND：接地
- TX：串口发送
- RX：串口接收

#### [DAPlink](./images/DAPlink.jpg)引脚：
- 5V：5V电源输出
- GND：接地
- SWDIO：SWD数据线
- SWCLK：SWD时钟线
...
# 声明：
本项目仅供学习和交流，禁止违法使用。制作一模多卡设备是犯罪行为，任何利用本项目代码或其衍生品的行为均与项目作者无关。